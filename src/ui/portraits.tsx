...
const PORTRAITS: Record<GeneralId, () => ReactNode> = {
  ...
  // 风包
  xiahouyuan: () => Generic({ skin: '#dcae7e', robe: '#2f4a6b', trim: '#cfd8e3', hat: 'helmet', hatColor: '#31465f', beard: 'stubble', fierce: true, extra: 'feather' }),
  caoren: () => Generic({ skin: '#d9a877', robe: '#3a5170', trim: '#8a94a0', hat: 'helmet', hatColor: '#26374d', beard: 'short' }),
  huangzhong: () => Generic({ skin: '#d9a877', robe: '#8a4536', trim: '#d8b84a', hat: 'ribbon', hatColor: '#6b5638', beard: 'full', beardColor: '#e8e4da', old: true, fierce: true }),
  weiyan: () => Generic({ skin: '#c98a55', robe: '#7a3a30', trim: '#caa14a', hat: 'helmet', hatColor: '#5c2b24', beard: 'stubble', fierce: true, extra: 'scar' }),
  xiaoqiao: () => Generic({ skin: '#f8e3cc', robe: '#e0949e', trim: '#f8ecd8', female: true }),
  ...
  // 林包
  caopi: () => Generic({ skin: '#ecd6b0', robe: '#3a5170', trim: '#d8b84a', hat: 'circlet', beard: 'mustache' }),
  xuhuang: () => Generic({ skin: '#dcae7e', robe: '#2f4a6b', trim: '#cfd8e3', hat: 'helmet', hatColor: '#24344c', beard: 'short' }),
  ...
  // 山包
  dengai: () => Generic({ skin: '#d9a877', robe: '#2f4a6b', trim: '#8a94a0', hat: 'helmet', hatColor: '#2a3a50', beard: 'goatee', beardColor: '#cfcabb', old: true }),
  zhanghe: () => Generic({ skin: '#e0b184', robe: '#3a5170', trim: '#cfd8e3', hat: 'helmet', hatColor: '#26374d', beard: 'mustache' }),
  jiangwei: () => Generic({ skin: '#e8c49a', robe: '#8a4536', trim: '#d8b84a', hat: 'helmet', hatColor: '#5c2b24', beard: 'none', fierce: true, extra: 'feather' }),
  liushan: () => Generic({ skin: '#f2ddc0', robe: '#4a7a68', trim: '#d8b84a', hat: 'circlet', beard: 'none' }),
  sunce: () => Generic({ skin: '#dcae7e', robe: '#a5443a', trim: '#d8b84a', hat: 'ribbon', hatColor: '#7a2f28', beard: 'none', fierce: true, extra: 'plume' }),
